...
# Примечание:
# при написание программы обратите внимание на условия в задаче и в вашем коде.
...
print('Здравствуйте! Вас приветствует программа "Медицинская Анкета"')
...
if (age < 40 and age < 30) and (weight > 120 or weight < 50):
    print('Пациенту требуется заняться собой')
if (age > 40 and age < 120) and (weight > 120 or weight < 50):
    print('Пациенту следует обратится к врачу!')
if age > 120 or weight > 300:
    print('Пациенту следует обратится в Книгу Рекордов Гиннеса')
if weight !=0:
    print('Данные пациента записаны. Спасибо')
